...
namespace PortailReserve.DAL.Impl
{
    public class PhotoDal : IPhotoDal
    {
        ...
        public Guid AjouterPhoto(Photo photo)
        {
            ...
            {
                LOGGER.Log("ERROR", "Erreur ajout de photo -> " + e);
                return Guid.Empty;
            }
        }
        ...
        public List<Photo> GetAllPhotos()
        {
            ...
            {
                LOGGER.Log("ERROR", "Erreur récupération de toutes les photos -> " + e);
        ...
        public Photo GetPhotoById(Guid id)
        {
            ...
            {
                LOGGER.Log("ERROR", "Aucune photo trouvee pour l'id : " + id + " -> " + nfe);
                return new PhotoNull() { Error = "Photo introuvable." };
            }
            catch(Exception e)
            {
                LOGGER.Log("ERROR", "Erreur récupération photo par id : " + id + " -> " + e);
                return null;
            }
        }
        ...
        public List<Photo> GetPhotosByAlbum(Guid idAlbum)
        {
            ...
            {
                LOGGER.Log("ERROR", "Erreur récupération des photos de l'album id : " + idAlbum + " -> " + e);
                return new List<Photo>();
            }
        }
        ...
        public int SupprimerPhoto(Guid id)
        {
            try
            {
                ...
                {
                    LOGGER.Log("ERROR", "Aucune photo à supprimer pour l'id : " + id.ToString());
                    return 0;
                }
            ...
            {
                LOGGER.Log("ERROR", "Erreur suppression photo id : " + id + " -> " + e);
                return -1;
            }
        }
    }
